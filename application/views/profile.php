...
<html lang="en">
    ...
    <body onload="teacherProfileOnLoad();">
        ...
        <div id="main" class="container" style="padding-bottom:0px;">
                        ...
                        <div class="panel-body" style="padding-top:0px;padding-bottom:0px;">
                            <div class="row light_background">
                                <div class="col-sm-3" style="padding-top:15px;"><!-- teacher_id,  pic_url  -->
                                    <img id="teacherProfilePic" alt="Profile Picture"
                                         src="" class="img-rounded img-responsive" align="middle">
                                    <input type="hidden" id="teacherProPicUrl" 
                                    ...
                                    <button id="button" class="btn btn-default" style="margin-top:10px;"
                                            data-toggle="modal" data-target="#changePrivacyModal"
                                            data-backdrop="static" data-keyboard="true">
                                        <span class="glyphicon glyphicon-cog"></span>&nbsp;&nbsp;<strong>CHANGE PRIVACY SETTINGS</strong>
                                    </button>
                                </div>
                                <div class="col-sm-9">
                                        ...
                                        <tr style="background:#cccccc;">
                                            <td class="profile_details_3" >
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-2">
                                                        <span id="editFirstName" class="editProfileSpan" onclick="editProfileField('teacher', 'editFirstName', 'firstNameContent', 'firstname');"
                                            ...
                                            <td class="profile_details_3" >
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-2">
                                                        <span id="editMiddleName" class="editProfileSpan" onclick="editProfileField('teacher','editMiddleName', 'middleNameContent', 'middlename');"
                                            ...
                                            <td  class="profile_details_3">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-2">
                                                        <span id="editLastName" class="editProfileSpan" onclick="editProfileField('teacher', 'editLastName', 'lastNameContent', 'lastname');"
                                        ...
                                        <tr style="background:#cccccc;">
                                            <td class="profile_details_3" >
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-4" style="text-align:right;">
                                                        <span id="editDOB" class="editProfileSpan" onclick="editProfileDateField('teacher', 2000, 'editDOB', 'DOBContent', 'date_of_birth', 'selectDOB');"
                                            ...
                                            <td class="profile_details_3" >
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-4" style="text-align:right;">
                                                        <span id="editDOA" class="editProfileSpan" onclick="editProfileDateField('teacher', 2016, 'editDOA', 'DOAContent', 'date_of_anniversary', 'selectDOA');"
                                            ...
                                            <td class="profile_details_3" >
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-4" style="text-align:right;">
                                                        <span id="editDOJ" class="editProfileSpan" onclick="editProfileDateField('teacher', 2016, 'editDOJ', 'DOJContent', 'date_of_joining', 'selectDOJ');"
                                                              data-toggle="tooltip" data-placement="bottom" title="Edit Date Of Joining">
                                                            <span class="glyphicon glyphicon-pencil"></span>
                                                        </span>
                                                    </div>
                                        ...
                                        <tr style="background:#cccccc;">
                                            <td class="profile_details_3" >
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-2">
                                                        <span id="editTeacherRegNo" class="editProfileSpan" onclick="editProfileField('teacher', 'editTeacherRegNo', 'teacherRegNo', 'teacher_school_num');"
                                            ...
                                            <td class="profile_details_3" >
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-2">
                                                        <span id="editQualification" class="editProfileSpan" onclick="editProfileField('teacher', 'editQualification', 'teacherQualification', 'qualification');"
                                            ...
                                            <td  class="profile_details_3">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-2">
                                                        <span id="editExperience" class="editProfileSpan" onclick="editProfileField('teacher', 'editExperience', 'teacherExperience', 'experience');"
                                        ...
                                        <tr style="background:#cccccc;">
                                            <td style="text-align:center; width:75%;">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-2">
                                                        <span id="editAddress" class="editProfileSpan" onclick="editAddressField('teacher', 'editAddress', 'teacherAddress', 'address');"
                                            ...
                                            <td style="text-align:center; width:25%;">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-2">
                                                        <span id="editPincode" class="editProfileSpan" onclick="editProfileField('teacher', 'editPincode', 'teacherPincode', 'pincode');"
                                        ...
                                        <tr style="background:#cccccc;">
                                            <td class="profile_details_2" >
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-2">
                                                        <span id="editPhone" class="editProfileSpan" onclick="editProfileField('teacher', 'editPhone', 'teacherPhone', 'phone');"
                                            ...
                                            <td class="profile_details_2" >
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-2">
                                                        <span id="editEmail" class="editProfileSpan" onclick="editProfileField('teacher', 'editEmail', 'teacherEmail', 'email_id');"
                                        ...
                                        <tr style="background:#cccccc;">
                                            <td class="profile_details_2" >
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-2">
                                                        <span id="editTwitter" class="editProfileSpan" onclick="editProfileField('teacher', 'editTwitter', 'teacherTwitter', 'twitter');"
                                            ...
                                            <td class="profile_details_2" >
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-2">
                                                        <span id="editBlog" class="editProfileSpan" onclick="editProfileField('teacher', 'editBlog', 'teacherBlog', 'blog');"
                                        ...
                                        <tr style="background: #cccccc;">
                                            <td style="width:50%;text-align: center;" colspan="2">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-4" style="text-align:right;">
                                                        <span id="editHobbies" class="editProfileSpan" onclick="editBulkField('teacher', 'editHobbies', 'hobby_', 'hobby_');"
                                            ...
                                            <td style="width:50%;text-align: center;" colspan="2">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-4" style="text-align:right;">
                                                        <span id="editAchievements" class="editProfileSpan" onclick="editBulkField('teacher', 'editAchievements', 'achievement_', 'achievement_');"
                                                              data-toggle="tooltip" data-placement="bottom" title="Edit">
                                                            <span class="glyphicon glyphicon-pencil"></span>
                                                        </span>
                                                    </div>
                        ...
                        <div class="modal-body" id="changePictureContent">
                            <form id="uploadProPicForm" name="uploadProPicForm" method="post"
                                ...
                                <div class="form-group" style="text-align:center;">
                                    <input type="hidden" id="upload_user_type" name="upload_user_type" value="teacher">
            ...
            <div id="changePrivacyModal" class="modal fade" role="dialog" style="height:100%;">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header light_background">
                            <button type="button" class="close" data-dismiss="modal">&times;<small>CLOSE</small></button>
                            <h4 class="modal-title" id="changePrivacyTitle" style="text-align:center;"><strong>CHANGE PRIVACY SETTINGS</strong></h4>
                        </div>
                        <div class="modal-body" id="changePrivacyContent">
                            <input type="hidden" id="profile_type" value="teacher">
                            <form id="privacy_form" name="privacy_form" action="/changePrivacy" method="post">
                                <table class="table table-bordered table-striped" id="privacy_table">
                                    <tr>
                                        <td class="privacy_desc">Date Of Birth</td>
                                        <td class="privacy_options">
                                            <select class="form-control" id="dob_priv" name="dob_priv" >
                                                <option value="">Loading...</option>
                                                <option value="<?php echo _TEACHER_PRIVACY_LEVEL_1; ?>">
                                                    <?php echo _TEACHER_PRIVACY_LEVEL_1_DESC; ?>
                                                </option>
                                                <option value="<?php echo _TEACHER_PRIVACY_LEVEL_2; ?>">
                                                    <?php echo _TEACHER_PRIVACY_LEVEL_2_DESC; ?>
                                                </option>
                                                <option value="<?php echo _TEACHER_PRIVACY_LEVEL_3; ?>">
                                                    <?php echo _TEACHER_PRIVACY_LEVEL_3_DESC; ?>
                                                </option>
                                            </select>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="privacy_desc">Marriage Date</td>
                                        <td class="privacy_options">
                                            <select class="form-control" id="doa_priv" name="doa_priv" >
                                                <option value="">Loading...</option>
                                                <option value="<?php echo _TEACHER_PRIVACY_LEVEL_1; ?>">
                                                    <?php echo _TEACHER_PRIVACY_LEVEL_1_DESC; ?>
                                                </option>
                                    ...
                                    <tr>
                                        <td class="privacy_desc">Date Of Joining</td>
                                        <td class="privacy_options">
                                            <select class="form-control" id="doj_priv" name="doj_priv" >
                                                <option value="">Loading...</option>
                                                <option value="<?php echo _TEACHER_PRIVACY_LEVEL_1; ?>">
                                                    <?php echo _TEACHER_PRIVACY_LEVEL_1_DESC; ?>
                                                </option>
                                    ...
                                    <tr>
                                        <td class="privacy_desc">Qualification</td>
                                        <td class="privacy_options">
                                            <select class="form-control" id="qual_priv" name="qual_priv" >
                                                <option value="">Loading...</option>
                                                <option value="<?php echo _TEACHER_PRIVACY_LEVEL_1; ?>">
                                                    <?php echo _TEACHER_PRIVACY_LEVEL_1_DESC; ?>
                                                </option>
                                    ...
                                    <tr>
                                        <td class="privacy_desc">Address</td>
                                        <td class="privacy_options">
                                            <select class="form-control" id="address_priv" name="address_priv" >
                                                <option value="">Loading...</option>
                                                <option value="<?php echo _TEACHER_PRIVACY_LEVEL_1; ?>">
                                                    <?php echo _TEACHER_PRIVACY_LEVEL_1_DESC; ?>
                                                </option>
                                    ...
                                    <tr>
                                        <td class="privacy_desc">Phone Number</td>
                                        <td class="privacy_options">
                                            <select class="form-control" id="phone_priv" name="phone_priv" >
                                                <option value="">Loading...</option>
                                                <option value="<?php echo _TEACHER_PRIVACY_LEVEL_1; ?>">
                                                    <?php echo _TEACHER_PRIVACY_LEVEL_1_DESC; ?>
                                                </option>
                                    ...
                                    <tr>
                                        <td class="privacy_desc">Email</td>
                                        <td class="privacy_options">
                                            <select class="form-control" id="email_priv" name="email_priv" >
                                                <option value="">Loading...</option>
                                                <option value="<?php echo _TEACHER_PRIVACY_LEVEL_1; ?>">
                                                    <?php echo _TEACHER_PRIVACY_LEVEL_1_DESC; ?>
                                                </option>
                                    ...
                                    <tr>
                                        <td class="privacy_desc">Twitter</td>
                                        <td class="privacy_options">
                                            <select class="form-control" id="twitter_priv" name="twitter_priv" >
                                                <option value="">Loading...</option>
                                                <option value="<?php echo _TEACHER_PRIVACY_LEVEL_1; ?>">
                                                    <?php echo _TEACHER_PRIVACY_LEVEL_1_DESC; ?>
                                                </option>
                                    ...
                                    <tr>
                                        <td class="privacy_desc">Blog</td>
                                        <td class="privacy_options">
                                            <select class="form-control" id="blog_priv" 
                                                    name="blog_priv" onchange="onPrivacyOptionChg(this);">
                                                <option value="">Loading...</option>
                                                <option value="<?php echo _TEACHER_PRIVACY_LEVEL_1; ?>">
                                                    <?php echo _TEACHER_PRIVACY_LEVEL_1_DESC; ?>
                                                </option>
                                ...
                                <div style="text-align:center;">
                                    <input type="submit" class="btn btn-primary" style="font-weight: bold;"
                                               id="privacy_submit_btn" name="privacy_submit_btn" value="SUBMIT" >
                                </div>
                            </form>
                        </div>
                    </div>
